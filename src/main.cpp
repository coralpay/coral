...
int nCoinbaseMaturity = 20; //25 blocks for coins to mature
...
const string strMessageMagic = "Coral Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (pindexBest->nHeight < 20) { nSubsidy = 1050000 * COIN; } // CORAL 21
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Coral", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "dao disaster 2016";
        CTransaction txNew;
        txNew.nTime = 1479765821;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1479765821;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1041213;
        if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x019377de32e7f02f54203fcdabcd0c51922efc33c110bbe278eb9406646a0391"));
        block.print();
