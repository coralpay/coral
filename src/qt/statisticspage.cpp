...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " CORAL" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " CORAL" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " CORAL");
    }
