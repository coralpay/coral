...
{
    resize(850, 550);
    setWindowTitle(tr("Coral") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Coral address"));
  ...
  blockAction = new QAction(tr("&Block Explorer"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Coral"), this);
    aboutAction->setToolTip(tr("Show information about Coral"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for Coral"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Coral client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Coral client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Coral network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Coral address or malformed URI parameters."));
    }
